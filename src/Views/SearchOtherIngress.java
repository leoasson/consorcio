    ...
    private void setTitletable(boolean[] filter)
    {
        ...
        switch(Arrays.toString(filter))
            { 
                ...
                break;        
                case "[false, true]":
                title_ = "Detalle de ingresos diferentes para el año "+year; 
                break;                               
                case "[true, true]":
                title_ = "Detalle de ingresos diferentes para el mes "+ month+" del año "+year;  
                break;  
                default:
                title_ = "Detalle de todos los ingresos diferentes"; 
                break;
...
//    
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Está seguro que eleminar el ingreso?", "Atención",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) 
        {
            if(row < 0)
            {
                JOptionPane.showMessageDialog(null,"Seleccione la fila deseada.","Atención",JOptionPane.WARNING_MESSAGE);
